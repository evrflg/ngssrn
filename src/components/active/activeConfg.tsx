...
export const activeTheme: any = {
  greenBlack: {
    ...
    btnGradient: { s: '#75eb92', e: '#A9E782' },
    activeTabBg: { s: '#00E09E', e: '#75EB92' },
    tabGameActiveBg: { s: '#ff9902', e: '#ffd058' },
    firstDepositRefundBg: { s: '#202222', e: 'rgba(169, 231, 130, 0.2)' },
    promotListBg: { s: '#2A2D2B', e: '#406441' },
    tabBorder: { s: 'transparent', e: 'rgba(255, 255, 255, 0.5)' },
  },
  blueWhite: {
    banner: { s: 'rgba(204, 220, 255, 1)', e: 'rgba(255, 255, 255, 0)' },
    box: { s: 'rgba(204, 220, 255, 1)', e: 'rgba(255, 255, 255, 0)' },
    image: require('@/assets/images/active/blue.png'),
    btnGradient: { s: '#4781ff', e: '#4781ff' },
    activeTabBg: { s: '#262729', e: '#4781ff' },
    tabGameActiveBg: { s: '#4781ff', e: '#4781ff' },
    firstDepositRefundBg: { s: '#EBECF3', e: 'rgba(164, 193, 255, 0.3)' },
    promotListBg: { s: '#4781FF', e: '#47B5FF' },
    tabBorder: { s: 'transparent', e: 'rgba(255, 255, 255, 0.5)' },
  },
  orangeWhite: {
    banner: { s: 'rgba(244, 141, 22, 0.56)', e: 'rgba(255, 255, 255, 0)' },
    box: { s: 'rgba(244, 141, 22, 0.56)', e: 'rgba(255, 255, 255, 0)' },
    image: require('@/assets/images/active/orange.png'),
    btnGradient: { s: '#F48D16', e: '#A9E782' },
    activeTabBg: { s: '#fcbc42', e: '#F48D16' },
    tabGameActiveBg: { s: '#ff9902', e: '#ffd058' },
    firstDepositRefundBg: { s: '#EBECF3', e: 'rgba(249, 195, 131, 0.3)' },
    promotListBg: { s: '#F48D16', e: '#FFD900' },
    tabBorder: { s: 'transparent', e: 'rgba(255, 255, 255, 0.5)' },
  },
};
...
export const activeCenterConfig = {
  promotion: {
    state(state: 1 | 2 | 3) {
      const boxImg: Record<1 | 2 | 3, any> = {
        1: require('@/assets/images/active/baoxiang1.png'),
        2: require('@/assets/images/active/baoxiang2.png'),
        3: require('@/assets/images/active/baoxiang3.png'),
      };
      return boxImg[state];
    }
  }
...
export const missionTheme: any = {
  ...
  blueWhite: {
    ...
    checkBox: { s: 'rgba(255,255,255,0.1)', e: 'rgba(218, 240, 255, 1)', m: 'rgba(174, 222, 255, 1)' },
    downlad: {
  ...
  orangeWhite: {
    ...
    checkBox: { s: 'rgba(255,255,255,0.1)', e: 'rgba(253, 232, 208, 1)', m: 'rgba(253, 232, 208, 1)' },
    downlad: {
...
export const profileTheme: any = {
  greenBlack: {
    cardBgImg: require('@/assets/images/myCenter/greenBlack-card.png'),
  },
  blueWhite: {
    cardBgImg: require('@/assets/images/myCenter/blue-card.png'),
  },
  orangeWhite: {
    cardBgImg: require('@/assets/images/myCenter/orange-card.png'),
  },
};

export const activeIntroduction = (intro?: string) => {
